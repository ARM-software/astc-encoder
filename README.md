...
By including a target PSNR value as an argument for astcenc, ASTC compression is performed using a block size that yields a PSNR value similar to or higher than the specified target value.
